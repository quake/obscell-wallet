...
/// Type script args: ct_info_script_hash (32B).
...
impl CtTxBuilder {
    ...
    fn build_ct_output(
        ...
        // Encrypt amount AND blinding factor using shared secret
        // This allows the recipient to recover the blinding factor for spending
    ...
    fn build_ct_change_output(
        ...
        // Encrypt amount AND blinding factor for ourselves using shared secret
        let encrypted = encrypt_amount_and_blinding(amount, blinding, &shared_secret);
...
mod tests {
    ...
    fn test_min_ct_cell_capacity() {
        ...
        // (increased from 223 CKB after cell data changed from 64B to 72B for v2 format)
